<x-layout :title='$title'>
    <div class="flex flex-col flex-1 w-full items-center fadeInBottom">
        <form action="/transactions/withdrawl/store" method="post" class="w-full lg:w-4/12 forms !gap-4">
            <div class="text-4xl font-bold text-center mb-4">Add Withdrawl</div>
            @csrf
            ...
            <div class="flex items-center gap-2">
                ...
                <input type="date" name="transaction_date" id="transaction_date" class="text-lg" value="{{ old('transaction_date') }}">
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <input type="number" name="cheque_no" id="cheque_no" placeholder="Cheque No." value="{{ old('cheque_no') }}">
            </div>
            @error('cheque_no')
                <p class="text-red-300 text-sm font-thin">{{ $message }}</p>
            @enderror
            ...
            <div class="flex items-center gap-4">
                <input class="w-4 ring-0 border-none outline-none focus:ring-0 focus:border-0 focus:outline-none smooth"
                    type="checkbox" name="verified" id="verified" value="VERIFIED">
